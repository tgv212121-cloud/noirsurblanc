  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: 'h-10 w-10 sm:h-8 sm:w-8 bg-white/5 hover:bg-[#ca8a04]/20 rounded-md inline-flex items-center justify-center text-blanc-muted hover:text-[#ca8a04] transition-colors pointer-events-auto cursor-pointer',
        button_next: 'h-10 w-10 sm:h-8 sm:w-8 bg-white/5 hover:bg-[#ca8a04]/20 rounded-md inline-flex items-center justify-center text-blanc-muted hover:text-[#ca8a04] transition-colors pointer-events-auto cursor-pointer',
        month_grid: 'w-full border-collapse',
        weekdays: 'flex gap-1.5 sm:gap-3',
        weekday: 'text-blanc-muted/50 flex-1 font-normal text-[10px] uppercase tracking-[0.1em] sm:tracking-[0.18em] py-2 sm:py-3 text-center',
        week: 'flex w-full mt-2 sm:mt-4 gap-1.5 sm:gap-3',
        day: 'flex-1 aspect-square text-center text-[13px] sm:text-[14px] relative p-0',
