  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weekdays: 'flex',
        weekday: 'text-blanc-muted/50 flex-1 font-normal text-[10px] uppercase tracking-[0.18em] py-2.5 text-center',
        week: 'flex w-full mt-1.5 gap-1.5',
        day: 'flex-1 aspect-square text-center text-[13px] relative p-0',
